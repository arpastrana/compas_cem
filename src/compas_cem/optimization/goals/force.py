from compas_cem.optimization.goals import FloatGoal
from compas_cem.optimization.goals import VectorGoal

__all__ = ["TrailEdgeForceGoal", "ReactionForceGoal"]


class TrailEdgeForceGoal(FloatGoal):
    """
    Make a trail edge reach a target force value.
    """

    def __init__(self, edge=None, force=None, weight=1.0):
        super(TrailEdgeForceGoal, self).__init__(edge, force, weight)
...
if __name__ == "__main__":
    ...
    optimizer.add_goal(ReactionForceGoal(1, [0.0, 0.0, 0.0]))
