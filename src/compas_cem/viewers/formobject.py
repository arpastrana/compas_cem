...
class FormObject(NetworkObject):
    """
    ...
    def __init__(self,
                 ...
                 show_edgetext=False,
                 **kwargs):
        super(FormObject, self).__init__(form_diagram, **kwargs)
    ...
    def draw_nodes(self):
        ...
        super(FormObject, self).draw_nodes(color=nc)
    ...
    def draw_edges(self):
        ...
        return super(FormObject, self).draw_edges(color=ec)
